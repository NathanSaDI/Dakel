...
?>
        ...
        <div id="infopassager" class="borderbottom">
            ...
            <div id="p1" class="ouoh">
                <div id="pl1">
                  ...
                  <?php if($row1["Civilite"]=="Homme") : ?>
                <img id="imghomme" src="Icons/photohomme.png" alt="">
        
                <?php  else: ?>
                    <img id="imghomme" src="Icons/photofemme.png" alt="">
                     <?php endif; ?> 
            </div>
            </a>
  ...
  ?>
    ...
    <a href="supprimerreservation.php?id_trajet=<?php echo $row['id_Trajet']; ?>" > <input type="submit" id="sub" value="Annuler" name="signup" ></a>
    <?php endif; ?>
